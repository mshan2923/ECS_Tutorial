...
public readonly partial struct SpawnerAspect : IAspect
{
    ...
    readonly RefRW<RemakedFluidSpawnComponent> spawn;
    ...
    public RemakedFluidSpawnComponent SpawnData => spawn.ValueRW;
    ...
    public partial struct SpawnJob : IJob
    {
        ...
        [ReadOnly]  public RemakedFluidSpawnComponent spawnComponent;
